...
class HitsComponent extends Component
{
    ...
    public function updatedPage($page)
    {
        ...
        $this->dispatch('page-updated', title: shopName()." :: Хіти продажів{$page_title}");
    }
    ...
    {
        // Get price range for hit products
        ...
        // Get categories that have hit products
        ...
        // Build products query for hit items only
        ...
        $title = 'Хіти продажів'.($page > 1 ? " :: Сторінка - {$page}" : '');

        return view('livewire.product.hits-component', [
            'products' => $products,
