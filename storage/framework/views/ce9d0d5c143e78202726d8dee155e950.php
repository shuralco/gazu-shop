...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'size' => 20, 'stroke' => 'currentColor', 'fill' => 'none', 'strokeWidth' => '1.6']));
...
foreach (array_filter((['name', 'size' => 20, 'stroke' => 'currentColor', 'fill' => 'none', 'strokeWidth' => '1.6']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php
    ...
    $svg = $paths[$name] ?? '';
?>
<svg width="<?php echo e($size); ?>" height="<?php echo e($size); ?>" viewBox="0 0 24 24" fill="<?php echo e($fill); ?>" stroke="<?php echo e($stroke); ?>" stroke-width="<?php echo e($strokeWidth); ?>" stroke-linecap="round" stroke-linejoin="round" <?php echo e($attributes); ?>>
    <?php echo $svg; ?>

</svg>
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/components/gazu/icon.blade.php ENDPATH**/ ?>