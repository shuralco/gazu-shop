...
<?php endif; ?>
        ...
        <div class="order-last w-full lg:order-none lg:w-auto lg:flex-1 min-w-0 relative"
            ...
            <form action="<?php echo e(route('gazu.search')); ?>" method="GET" class="flex items-stretch border-[1.5px] border-[var(--gazu-ink)] rounded-lg overflow-hidden bg-[var(--gazu-surface)]">
        ...
        <div x-show="megaOpen"
            ...
            <div class="fixed z-[56] left-2 right-2 top-2 bottom-2
                ...
                <template x-if="megaOpen">
                    ...
                    <?php echo \Illuminate\Support\Facades\Cache::tags(['gazu-menu'])->remember(
