    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-2 max-h-80 overflow-y-auto">
                ...
                <div class="p-3 bg-gray-50 rounded border">
                    <div class="flex items-center justify-between mb-2">
                        <div>
                            <span class="font-medium text-sm"><?php echo e($category->title); ?></span>
                            <span class="text-xs text-gray-500 ml-2">(<?php echo e($category->children->count()); ?> підкатегорій)</span>
                        </div>
                        <button 
                            onclick="addCategoryColumn('<?php echo e($category->title); ?>', <?php echo e($category->id); ?>)" 
                    ...
                    <div class="flex flex-wrap gap-1 mt-2">
                        ...
                        <button 
                            onclick="addSubcategoryToCurrentColumn('<?php echo e($child->title); ?>', <?php echo e($child->id); ?>)" 
        ...
        <div class="bg-white rounded-lg p-6 shadow">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900">🏗️ Структура <?php echo e($menuType === 'main' ? 'основного' : 'горизонтального'); ?> мега-меню</h3>
...
<script>
const menuType = '<?php echo e($menuType); ?>';
...
function autoGenerateStructure() {
    const categories = <?php echo json_encode($availableCategories, 15, 512) ?>;
...
function saveStructure() {
    ...
    window.Livewire.find('<?php echo e($_instance->getId()); ?>').call('saveMegaMenuStructure', currentStructure, menuType);
}
...
function loadCurrentStructure() {
    ...
    const structureJson = <?php echo json_encode($currentStructure, 15, 512) ?>;
    try {
...
</style><?php /**PATH /home/lionex/projects/gazu-shop/resources/views/filament/mega-menu-builder.blade.php ENDPATH**/ ?>