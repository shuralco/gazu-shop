        ...
        <aside class="gazu-auth-rail" aria-hidden="true">
            ...
            <div class="gazu-auth-rail-inner">
                ...
                <a href="https://lionex.com.ua" target="_blank" rel="nofollow noopener" class="gazu-auth-dev">
                    ...
                    <img src="<?php echo e(asset('lionex-logo.svg')); ?>" alt="LIONEX" />
                </a>

                <div class="gazu-auth-foot">
                    <span>© <?php echo e(date('Y')); ?> GAZU</span>
                    <a href="<?php echo e(url('/')); ?>" class="gazu-auth-foot-link">← на сайт</a>
                </div>
            </div>
        </aside>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/filament/pages/auth/login.blade.php ENDPATH**/ ?>