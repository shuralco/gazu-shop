...
<div x-data="{
        ...
        async submit() {
            ...
            try {
                const r = await fetch('<?php echo e(route('gazu.checkout.one-click')); ?>', {
                    method: 'POST',
...
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/components/gazu/one-click-modal.blade.php ENDPATH**/ ?>