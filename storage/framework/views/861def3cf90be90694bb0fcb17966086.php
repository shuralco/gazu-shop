...
<section class="my-5 sm:my-6">
    <div x-data="gazuCompatCheck({
            productId: <?php echo \Illuminate\Support\Js::from((int) $productId)->toHtml() ?>,
            api: { makes: <?php echo \Illuminate\Support\Js::from($apiMakes)->toHtml() ?>, models: <?php echo \Illuminate\Support\Js::from($apiModels)->toHtml() ?>, engines: <?php echo \Illuminate\Support\Js::from($apiEngines)->toHtml() ?>, check: <?php echo \Illuminate\Support\Js::from($apiCheck)->toHtml() ?> },
         })"
         x-init="init()"
...
<?php if (! $__env->hasRenderedOnce('9fa78263-21d6-4418-836d-1864bafbdf4f')): $__env->markAsRenderedOnce('9fa78263-21d6-4418-836d-1864bafbdf4f'); ?>
<script>
    (function() {
...
<?php endif; ?>
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/components/gazu/compat-check.blade.php ENDPATH**/ ?>