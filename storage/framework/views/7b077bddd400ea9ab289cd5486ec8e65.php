...
<head>
    ...
    <script>
        ...
        // CSRF Form Auto-Refresh: будь-який <form> з <?php echo csrf_field(); ?> input (_token) при submit
        // отримує СВІЖИЙ токен з window.GAZU_CSRF. Це fix для кешованого HTML де
        // <?php echo csrf_field(); ?> видає stale token (Spatie CsrfTokenReplacer оновлює лише meta, не inputs).
        ...
        (function () {
            window.GAZU_AUTH = <?php echo e(auth()->check() ? 'true' : 'false'); ?>;
            ...
            function loadIds() {
                if (window.GAZU_AUTH) {
                    fetch('<?php echo e(route('gazu.wishlist.ids')); ?>', { credentials: 'same-origin', headers: { 'Accept': 'application/json' } })
                        ...
                        .then(function (d) {
                            ...
                            var guest = lsGet();
                            if (guest.size) {
                                fetch('<?php echo e(route('gazu.wishlist.merge')); ?>', {
                                    method: 'POST',
            ...
            window.gazuWishlistToggle = function (pid) {
                pid = Number(pid);
                if (window.GAZU_AUTH) {
                    return fetch('<?php echo e(route('gazu.wishlist.toggle')); ?>', {
                        method: 'POST',
                ...
                if (added) {
                    window.gazuToast && window.gazuToast('Збережено в обране · увійдіть, щоб переглянути', 'info', { action: { label: 'Увійти', href: '<?php echo e(route('gazu.auth')); ?>' } });
                } else {
    ...
    <?php if((bool) (\App\Models\DisplaySetting::get('seo_noindex_all', true))): ?>
    ...
    ?>
    <script type="application/ld+json"><?php echo json_encode($orgLd, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT); ?></script>
...
<?php echo $__env->make('gazu.partials.header', ['activeNav' => $activeNav ?? null, 'cartCount' => $cartCount ?? 0], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('gazu.partials.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>


<?php if (isset($component)) { $__componentOriginal3fb535fcfe3d21b9f3c387b38056cc79 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3fb535fcfe3d21b9f3c387b38056cc79 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.gazu.one-click-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('gazu.one-click-modal'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal3fb535fcfe3d21b9f3c387b38056cc79)): ?>
<?php $attributes = $__attributesOriginal3fb535fcfe3d21b9f3c387b38056cc79; ?>
<?php unset($__attributesOriginal3fb535fcfe3d21b9f3c387b38056cc79); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3fb535fcfe3d21b9f3c387b38056cc79)): ?>
<?php $component = $__componentOriginal3fb535fcfe3d21b9f3c387b38056cc79; ?>
<?php unset($__componentOriginal3fb535fcfe3d21b9f3c387b38056cc79); ?>
<?php endif; ?>
...
<div x-data="{
        ...
        async fetchContents() {
            this.loading = true;
            try {
                const r = await fetch('<?php echo e(route('gazu.cart.contents')); ?>', { headers: { 'Accept': 'application/json' } });
        ...
        async setQty(item, qty) {
            ...
            try {
                await fetch('<?php echo e(route('gazu.cart.update')); ?>', {
                    method: 'POST',
        ...
        async removeItem(item) {
            ...
            this.busy[item.id] = true;
            try {
                await fetch('<?php echo e(route('gazu.cart.remove')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'Accept': 'application/json', 'X-CSRF-TOKEN': this._csrf() },
...
<?php if(session('cart_message') || session('flash_message') || session('order_message')): ?>
    <?php $msg = session('cart_message') ?? session('flash_message') ?? session('order_message'); ?>
    <script>setTimeout(() => window.gazuToast && window.gazuToast(<?php echo json_encode($msg, 15, 512) ?>, 'success'), 100);</script>
<?php endif; ?>
<?php if($errors->any()): ?>
...
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/gazu/layout.blade.php ENDPATH**/ ?>