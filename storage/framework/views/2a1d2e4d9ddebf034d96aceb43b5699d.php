...
<body>
    ...
    <p>Вимкнено <strong><?php echo e($count); ?></strong> модул<?php echo e($count === 1 ? 'ь' : 'ів'); ?>. Дані в БД залишилися — увімкнення поверне функціональність.</p>

    <?php if($count > 0): ?>
        <ul>
            <?php $__currentLoopData = $disabled; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/errors/safe-mode-success.blade.php ENDPATH**/ ?>