...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['categories' => null]));
...
foreach (array_filter((['categories' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
    ...
    <div class="flex items-end justify-between mb-7">
        <div>
            ...
            <h2 class="gazu-display text-[26px] sm:text-[34px] font-semibold text-[var(--gazu-ink)] m-0 leading-tight">
                <?php echo e($gazuSettings['gazu_section_categories'] ?? 'Усе для вашого авто'); ?>

            </h2>
        </div>
        <a wire:navigate href="<?php echo e(route('gazu.catalog')); ?>" class="text-sm text-[var(--gazu-blue)] no-underline inline-flex items-center gap-1.5 hover:gap-2 transition-all">
            Усі категорії <?php if (isset($component)) { $__componentOriginal6ccaa7247ed520b12783ad61ab722d64 = $component; } ?>
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a wire:navigate href="<?php echo e($c['url']); ?>"
               ...
               style="background: linear-gradient(135deg, <?php echo e($c['accent']); ?> 0%, color-mix(in srgb, <?php echo e($c['accent']); ?> 70%, #0E1B2C) 100%);">

                <?php if(! empty($c['photo'])): ?>
                    
                    <img src="<?php echo e($c['photo']); ?>" alt="<?php echo e($c['name']); ?>" loading="lazy" decoding="async"
                         class="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                    
                    <div class="absolute inset-0"
                         style="background: linear-gradient(to top, color-mix(in srgb, <?php echo e($c['accent']); ?> 55%, #0A1422) 0%, rgba(10,20,34,0.55) 38%, rgba(10,20,34,0.15) 70%, rgba(10,20,34,0.30) 100%);"></div>
                <?php else: ?>
                ...
                <div class="absolute inset-x-0 bottom-0 p-4">
                    <div class="gazu-display text-[18px] sm:text-[22px] font-semibold leading-tight mb-1" style="text-shadow: 0 1px 8px rgba(10,20,34,0.55);"><?php echo e($c['name']); ?></div>
                    ...
                    <?php if(! empty($c['subs'])): ?>
                        <div class="gazu-cat-subs flex flex-wrap gap-1 mt-2 opacity-90 transition-all duration-300 max-h-0 group-hover:max-h-24 overflow-hidden">
                            <?php $__currentLoopData = $c['subs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="inline-block px-2 py-0.5 bg-white/15 rounded text-[11px] truncate max-w-[120px]"><?php echo e($sub['label']); ?></span>
...
<?php /**PATH /home/lionex/projects/gazu-shop/resources/views/components/gazu/category-tiles.blade.php ENDPATH**/ ?>