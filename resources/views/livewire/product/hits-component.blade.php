<div>
    @section('metatags')
        <title>{{ shopName() . ' :: ' . __('general.meta_hits') }}</title>
        <meta name="description" content="{{ __('general.meta_hits_description') }}">
    @endsection
    ...
    <div class="pt-4 md:pt-6">
        ...
        <div class="max-w-screen-2xl mx-auto px-2 md:px-8 mb-1 md:mb-2">
            <nav class="flex items-center gap-2 text-sm font-medium">
                ...
                <span class="font-black text-black uppercase">{{ __('general.hits') }}</span>
            </nav>
        </div>

        <!-- Page Title -->
        <div class="max-w-screen-2xl mx-auto px-4 md:px-8 pb-8">
            <h1 class="text-4xl md:text-6xl font-black text-black mb-2">{{ __('general.hits') }}</h1>
            <p class="text-lg font-medium hidden md:block">{{ __('general.found_popular_products', ['count' => $products->total()]) }}</p>
        </div>
        ...
        <div class="max-w-screen-2xl mx-auto px-4 md:px-8">
            ...
            <div id="filter-modal" class="filter-modal-overlay">
                <div class="filter-modal-content">
                    ...
                    <div class="bg-black text-white p-6 flex items-center justify-between">
                        <h2 class="font-black text-xl lg:text-2xl">{{ __('general.filter_hits') }}</h2>
            ...
            @else
                ...
                <div class="border-4 border-black bg-white p-8 md:p-16 text-center mb-12">
                    ...
                    <h2 class="text-2xl md:text-4xl font-black mb-4">{{ __('general.no_hits') }}</h2>
                    <p class="text-lg font-medium mb-8">{{ __('general.no_hits_message') }}</p>
                    <button wire:click="clearFilters" 
