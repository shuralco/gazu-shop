...
@section('title', __('general.email_welcome_subject', ['shop' => shopName()]))
        ...
        <tr>
            <td style="text-align: center; padding-bottom: 32px;">
                ...
                <h2 style="margin: 0 0 8px 0; font-size: 26px; font-weight: 900; color: #000000; text-transform: uppercase; letter-spacing: 1px;">
                    {{ __('general.email_welcome_heading') }}
                </h2>
                <p style="margin: 0; font-size: 16px; color: #666666;">
                    {{ __('general.email_welcome_subheading', ['name' => $user->name ?? '']) }}
                </p>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td style="padding-bottom: 32px; border-bottom: 2px solid #000000;">
                <p style="margin: 0; font-size: 15px; color: #333333; line-height: 1.7;">
                    {{ __('general.email_welcome_text', ['shop' => shopName()]) }}
                </p>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td>
                <h3 style="margin: 0 0 20px 0; font-size: 14px; font-weight: 900; color: #000000; text-transform: uppercase; letter-spacing: 2px;">
                    {{ __('general.email_welcome_benefits_title') }}
                </h3>
            </td>
        </tr>
    </table>
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 32px;">
        <tr>
            <td style="text-align: center;">
                <a href="{{ url('/cabinet') }}" style="display: inline-block; background-color: #000000; color: #ffffff; font-size: 13px; font-weight: 800; letter-spacing: 2px; text-decoration: none; text-transform: uppercase; padding: 16px 40px;">
                    {{ __('general.email_go_to_account') }}
                </a>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; padding-top: 16px;">
                <a href="{{ url('/') }}" style="font-size: 13px; color: #000000; font-weight: 700; text-decoration: underline; text-transform: uppercase; letter-spacing: 1px;">
                    {{ __('general.email_start_shopping') }}
                </a>
            </td>
        </tr>
    </table>
