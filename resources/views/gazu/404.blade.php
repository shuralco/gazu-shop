@extends('gazu.layout')
@section('title', '404 — Сторінку не знайдено · GAZU')
@section('description', 'Шукана сторінка не існує. Скористайтеся пошуком або перейдіть до каталогу запчастин для китайських авто.')
...
<section class="gazu-container py-12 sm:py-20">
    <div class="max-w-2xl mx-auto text-center">
        ...
        <p class="text-[15px] text-[var(--gazu-graphite)] mb-7 max-w-md mx-auto leading-relaxed">{{ $desc }}</p>

        {{-- Search bar — centered, big --}}
        <form method="GET" action="{{ route('gazu.search') }}" class="max-w-md mx-auto mb-10">
            <div class="relative">
        ...
        @if($popular404 && $popular404->isNotEmpty())
            <div class="text-left">
