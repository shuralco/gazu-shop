        ...
        <div class="gazu-container gazu-grid-hero-vin">
            <div>
                ...
                <div class="flex flex-wrap gap-3 mt-6">
                    <a wire:navigate href="{{ route('gazu.catalog') }}" class="inline-flex items-center gap-2 px-5 py-3 bg-[var(--gazu-ink)] text-[var(--gazu-on-brand)] rounded-md text-[14px] font-semibold no-underline hover:bg-[var(--gazu-ink-2)] transition-colors">
                        Дивитись каталог
                    ...
                    <a href="tel:{{ $heroPhoneTel }}" class="inline-flex items-center gap-2 px-5 py-3 bg-[var(--gazu-surface)] text-[var(--gazu-ink)] rounded-md text-[14px] font-semibold no-underline shadow-[inset_0_0_0_1px_var(--gazu-line)] hover:shadow-[inset_0_0_0_1px_var(--gazu-ink)] transition-shadow">
