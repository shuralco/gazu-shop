    ...
    <section class="gazu-container py-10">
        <div class="grid lg:grid-cols-2 gap-4">
            ...
            <div class="bg-[var(--gazu-mist)] rounded-xl p-9 relative overflow-hidden min-h-[380px]">
                ...
                <a wire:navigate href="{{ route('gazu.catalog') }}" class="mt-3 w-full py-3.5 bg-[var(--gazu-ink)] text-[var(--gazu-on-brand)] border-0 rounded-md font-medium text-sm cursor-pointer text-center no-underline block">
