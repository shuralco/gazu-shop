...
<div x-data="{
    ...
    <div x-show="open" x-cloak
         ...
         class="absolute z-50 top-full mt-2 {{ $alignClass }} w-[290px] bg-[var(--gazu-surface)] border border-[var(--gazu-line)] rounded-xl shadow-[0_12px_32px_-8px_rgba(14,27,44,0.20)] overflow-hidden">
