        ...
        <div class="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center mb-14 lg:mb-20">
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    @php $gazuPhone = ($gazuSettings ?? [])['gazu_phone'] ?? '0 800 750 010'; $gazuPhoneTel = preg_replace('/\D+/', '', $gazuPhone); @endphp
                    <a href="tel:{{ $gazuPhoneTel }}" class="inline-flex items-center gap-2 px-5 py-3 bg-[var(--gazu-surface)] text-[var(--gazu-ink)] rounded-md text-[14px] font-semibold no-underline border border-[var(--gazu-line)] hover:border-[var(--gazu-ink)] transition-colors">
            ...
            {{-- Image collage 2x2 з ефектом offset --}}
